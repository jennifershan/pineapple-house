THREE.TubeGeometryNew = function( path, segments, radius, radiusSegments, closed, debug ) {
    ...
    var frames = new THREE.TubeGeometryNew.FrenetFrames(path, segments, closed),
...
THREE.TubeGeometryNew.prototype = Object.create( THREE.Geometry.prototype );

// For computing of Frenet frames, exposing the tangents, normals and binormals the spline
THREE.TubeGeometryNew.FrenetFrames = function(path, segments, closed) {
